...
- [ ] **INIT-01**: User can run `npx ui-hierarchy-mcp --init` from a project root and have a usage guide injected into `CLAUDE.md` (default target when no `--target` flag is passed).
